	...
	public void mostrarPedidosPendientesClienteVistaGestionOS() throws SQLException, DAOException {
		...
		if (!existe_cliente) {
			...
			if (this.miControlador.getListaPedidosPendientesCliente(email_cliente_pedido).size() > 0) {
				...
				System.out.println(
						"No se ha podido mostrar la lista de pedidos pendientes para este cliente, ya que no se ha registrado ningún pedido pendiente en este momento para el cliente indicado.");
			}
		}
	}
