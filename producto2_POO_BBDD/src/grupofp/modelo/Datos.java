...
public class Datos {
	...
	// Constante para indicar el tipo de Factoría a utilizar (1: mySQL directamente,
	// 2: ORM Hibernate)
	...
	public void validarTipoCliente(String tipo_cliente) throws InvalidClientTypeException {
		...
		if (!tipo_cliente.matches(tipo_estandar) && !tipo_cliente.matches(tipo_premium)) {
			throw new InvalidClientTypeException(
					"Es necesario introducir valor válido para indicar el tipo de cliente. El valor puede indicarse escribiendo por teclado: \"estandar\" o \"premium\".");
		}
		// Si el tipo de cliente se ha indicado correctamente, se continúa con la
		// ejecución
	}
	...
	public ListaArticulos getListaArticulos() throws SQLException, DAOException {
		...
		// Instaciamos un articuloDAO de la factoría indicada para persistir un nuevo
		// Articulo
	...
	public void crearArticulo(String codigo_articulo, String descripcion_articulo, float pvp_articulo,
		...
		try {
			...
			if (this.articulo != null) {
				System.out.println("");
				System.out
						.println("Se está intentando añadir a la bd un artículo, con las siguientes características:");
	...
	public void crearPedido(String email_cliente, String codigo_articulo, LocalDateTime fechaHora,
		...
		if (articulo == null) {
			...
			System.out
					.println(
							"Se está intentando generar un pedido con un email de cliente no registrado, por favor, para proceder al registro introduzca:");
	...
	public void eliminarPedido(int numPedido) {
		...
		try {
			...
			if (pedido == null) {
				System.out.println(
						"Se ha indicado un número de pedido para eliminar pedido, que no se corresponde con ningún pedido existente.");
			} else {
